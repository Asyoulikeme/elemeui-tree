<template>
  <el-collapse accordion>
    <el-collapse-item v-for="(HttpQueryAction,HttpQueryActionIndex) in getHttpQueryActionInterfaceConfig" :key="HttpQueryActionIndex">
      ...
      <el-form :model="HttpQueryAction">
        ...
        <fieldset>
          ...
          <i class="el-icon-circle-plus" @click.stop="addSqlColumns(HttpQueryActionIndex)"> 添加</i>
          <el-collapse accordion>
            <el-collapse-item v-for="(sqlColumns,sqlColumnsIndex) in HttpQueryAction.sqlColumns" :key="sqlColumnsIndex">
        ...
        <fieldset>
          <i class="el-icon-circle-plus" @click.stop="addConditions(HttpQueryActionIndex)"> 添加</i>
          <legend>conditions[ ]</legend>
          <el-collapse accordion>
            <el-collapse-item v-for="(conditions,indexof) in HttpQueryAction.conditions" :key="indexof">
              <div slot="title" class="title-desc">
                conditions -- {{indexof}}
              </div>
        ...
        <fieldset>
          <i class="el-icon-circle-plus" @click.stop="addSorts(HttpQueryActionIndex)"> 添加</i>
          <legend>sorts[ ]</legend>
          <el-collapse accordion>
            <el-collapse-item v-for="(sorts,indexof) in HttpQueryAction.sorts" :key="indexof">
              <div slot="title" class="title-desc">
                sorts -- {{indexof}}
              </div>
  ...
  export default {
    ...
    methods:{
      addSqlColumns(indexOf){
        ...
        this.moduleConfig[this.index].interfaceConfig.HttpQueryAction[indexOf].sqlColumns.push(item)
      },
      addConditions(indexOf){
        ...
        this.moduleConfig[this.index].interfaceConfig.HttpQueryAction[indexOf].conditions.push(item)
      },
      addSorts(indexOf){
        let item = {
          sortId:'',
        ...
        this.moduleConfig[this.index].interfaceConfig.HttpQueryAction[indexOf].sorts.push(item)
      }
    }
  };
</script>
